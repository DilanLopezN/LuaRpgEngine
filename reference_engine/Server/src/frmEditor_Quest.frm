...
Private Sub txtItemQnt_Change()
If EditorIndex = 0 Or EditorIndex > MAX_QUESTS Then Exit Sub
    
    If Not IsNumeric(txtItemQnt.Text) Then
        MsgBox "Tarefa>ItemQnt precisa ser numérico"
        txtItemQnt.Text = "0"
        Exit Sub
    End If
    
    Quest(EditorIndex).ItemQnt(1) = txtItemQnt.Text
End Sub
