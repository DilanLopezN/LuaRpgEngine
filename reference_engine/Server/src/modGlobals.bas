...
Public Torneio As Byte
Public TorneioAtivo As Byte
Public Noticias_MAX As Byte
Public MinutoAviso As Byte
Public EventoExpCount As Byte
Public SegundosLuta As Long
Public SegundosParaAtualizarEvento As Long

Public kageLutou As Byte
Public desafioNum As Byte

' Used for closing key doors again
Public KeyTimer As Long
Public PlayerEchi As Long
