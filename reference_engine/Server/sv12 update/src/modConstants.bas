...
Public Const MAX_CLASS_TEMP As Byte = 15
...
Public Const MAX_PLAYERS As Long = 100
...
Public Const MAX_LEVELS As Long = 5000
...
Public Const ORG_UNDERWORLD As Byte = 12
Public Const ORG_VECTOR As Byte = 13
...
Public Const TORNEIO_JS As Byte = 2
Public Const TORNEIO_AS As Byte = 3
Public Const TORNEIO_SS As Byte = 4
...
Public Const TORNEIO_MATA As Byte = 11
Public Const TORNEIO_INVASÃO As Byte = 12
