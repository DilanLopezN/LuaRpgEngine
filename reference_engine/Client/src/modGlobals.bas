...
Public muteChat As Boolean

Public captchaTmr As Long
Public captcha As String
Public captchaTry As Long

Public ChatDelay As Long
Public HotBarDelay As Long

Public cheatTimer As Byte
Public enableChatTmr As Long

Public tmpInvNum As Long

Public RespostasCertas As Byte
Public TotalPerguntas As Byte
Public PerguntaIndex As Byte
Public RespostasCertasRequeridas As Byte
Public PerguntasCount As Byte

Public NomesDesafio(1 To 3) As String
Public ArenasOcUpAdAs As Byte

Public MoveX As Long
Public MoveY As Long

Public AntiSpeed1 As Long
Public AntiSpeed2 As Long
Public AntiSpeedDif As Byte

Public AFK As Long

Public Lutadores(1 To 3) As String
Public COUNT_FREEZE As Byte
Public Ready2GO As Byte

Public PlayerMP As String

'CHAT
Public ChatPlayer As String
...
Public SpellCDTime(1 To MAX_PLAYER_SPELLS) As Byte
...
Public ClickScriptado As Long
Public TileScriptado As Long
...
' weather
Public DropRain(1 To MAX_RAINDROPS) As DropRec 'temperatura
Public DropSnow(1 To MAX_SNOWDROPS) As DropRec 'neve 'temperatura
Public DropBird(1 To MAX_BIRDDROPS) As DropRec
Public DropSand(1 To MAX_SANDDROPS) As DropRec

Public Village As Byte
Public ElementoNum As Byte
Public SenhaSecreta As String
Public SenhaSecreta2 As String
