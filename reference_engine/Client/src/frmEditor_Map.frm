...
Begin VB.Form frmEditor_Map 
   ...
   Begin VB.Frame fraAnimation 
      ...
      Begin VB.ListBox lstAnimation 
         ...
         Width           =   2295
      End
      Begin VB.CommandButton cmdAnimFill 
         Caption         =   "Fill"
         Height          =   375
         Left            =   2640
         TabIndex        =   91
      ...
      Begin VB.Label Label2 
         Caption         =   "Select an animation from the list then place it on the map. Loop count will be ignored and the animation will continiously play."
         Height          =   855
         Left            =   2640
         TabIndex        =   94
         Top             =   360
      ...
      Begin VB.Label Label3 
         Caption         =   "To close this box, simply select 'Layers', 'Attributes' or 'Block'."
         Height          =   495
         Left            =   2640
         TabIndex        =   93
         Top             =   1200
   ...
   Begin VB.PictureBox picAttributes 
      ...
      Visible         =   0   'False
      Width           =   7095
      Begin VB.Frame FraScriptedTile 
         Caption         =   "ScriptedTile"
         Height          =   4935
         Left            =   480
         TabIndex        =   102
         Top             =   840
         ...
         Begin VB.CommandButton Command2 
            ...
            Width           =   1215
         End
         Begin VB.HScrollBar scrlScriptedTile 
            Height          =   615
            Left            =   1080
            Max             =   255
            TabIndex        =   104
   ...
   Begin VB.Frame fraAttribs 
      ...
      Visible         =   0   'False
      Width           =   1455
      Begin VB.OptionButton optScriptedTile 
         Caption         =   "ScriptedTile"
         Height          =   255
         Left            =   120
         TabIndex        =   106
...
Dim X As Long, Y As Long
    For X = 0 To MAP.MaxX
        For Y = 0 To MAP.MaxY
            MAP.Tile(X, Y).Animation.Animation = 0 'animação
        Next
    Next
End Sub
...
Dim X As Long, Y As Long
    For X = 0 To MAP.MaxX
        For Y = 0 To MAP.MaxY
            MAP.Tile(X, Y).Animation.Animation = lstAnimation.ListIndex + 1 'animação
        Next
    Next
End Sub
...
ClickScriptado = scrlOnClick.value
    picAttributes.Visible = False
    FraOnClick.Visible = False
End Sub

Private Sub Command2_Click()
TileScriptado = scrlScriptedTile.value
    picAttributes.Visible = False
    FraScriptedTile.Visible = False
End Sub
...
Private Sub optScriptedTile_Click()
picAttributes.Visible = True
    FraScriptedTile.Visible = True
End Sub
...
Private Sub scrlScriptedTile_Change()
lblSN.Caption = "Script: " & scrlScriptedTile.value
End Sub
